...
PADDLE_OFFSET = 30
#: the distance the paddle moves with each key press
PADDLE_STEP = 1
#: the y-coordinate of the top of the paddle. Used to detect collisions with the ball.
#PADDLE_TOP = the y-position of the paddle (presuming it's measured from the bottom left) + 11
...
#: the brick's color (list)
BRICK_COLOR    = ['red', 'orange', 'yellow', 'green', 'cyan']
